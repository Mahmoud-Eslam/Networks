...
public class server2 {
	  ...
	  private static final clientThread1[] threads = new clientThread1[maxClientsCount];
	    ...
	    while (true) {
	      try {
	        ...
	        for (i = 0; i < maxClientsCount; i++) {
	          if (threads[i] == null) {
	            (threads[i] = new clientThread1(clientSocket, threads,list)).start();
	            break;
	          }
	        }
	...
	class clientThread1 extends Thread {
	  ...
	  private Socket subserver2 =null;
	  private String clientName = null;
	  private DataInputStream is = null;
	  private PrintStream os = null;
	  private Socket clientSocket = null;
	  private final clientThread1[] threads;
	  private int maxClientsCount;
	  private String[] list;

	  public clientThread1(Socket clientSocket, clientThread1[] threads,String[] list) {
	...
	public void run() {
	    ...
	    clientThread1[] threads = this.threads;
	            ...
	            if (!words[1].isEmpty()) {
	              synchronized (this) {            	 
	    	        ...
	    	        if (b==false ){
	    	        	...
	    	        	try {
	    					subserver2 = new Socket("localhost",3733);
	    	        ...
	    	        try {
	    				os1 = new PrintStream(subserver2.getOutputStream());
